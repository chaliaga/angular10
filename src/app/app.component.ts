        ...
        this.items = [
            {
                ...
                items: [
                    ...
                    { label: 'Platos Criollos', icon: 'pi pi-home', routerLink: ['/app-menu'], queryParams: {'category': 'b347f8fa-cbf5-4803-a761-9c273e00e20a'} },
                    { label: 'Platos Marinos', icon: 'pi pi-filter', routerLink: ['/app-menu'], queryParams: {'category': 'f4c31031-bee0-4228-95f4-a485b48484c4'}},
                    { label: 'Quit' }
                ]
            }
        ];
